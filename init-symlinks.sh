...
declare -a LINKS=(
    ...
    "collections/hobby-electronics/pdfs:${LIBRARY_BASE}/hobby-electronics"
    "collections/hobby-electronics/indexed:${LIBRARY_BASE}/library-indexed/hobby-electronics"
    "collections/eti/pdfs:${LIBRARY_BASE}/eti"
    "collections/eti/indexed:${LIBRARY_BASE}/library-indexed/eti"
    "collections/bernards-babani/pdfs:${LIBRARY_BASE}/bernards-babani"
    "collections/bernards-babani/indexed:${LIBRARY_BASE}/library-indexed/bernards-babani"
    "collections/moritz-klein/pdfs:${LIBRARY_BASE}/moritz-klein"
    "collections/moritz-klein/indexed:${LIBRARY_BASE}/library-indexed/moritz-klein"
    "collections/everyday-electronics/pdfs:${LIBRARY_BASE}/everyday-electronics"
    "collections/everyday-electronics/indexed:${LIBRARY_BASE}/library-indexed/everyday-electronics"
)
